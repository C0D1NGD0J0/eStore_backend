...
const { getAllProducts, createProduct, getCategoryProducts, featuredProducts, addToWishlist, getProduct, updateProduct, toggleProductStatus, deleteProduct, removeWishlistItem, relatedProducts, searchProducts } = require("../Controllers/product.js");
